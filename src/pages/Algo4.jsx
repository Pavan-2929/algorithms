  ...
  <div className="container mx-auto px-4 py-8">
    ...
    <div className="bg-gray-100 rounded-lg p-6 mb-6 transition-all duration-300 hover:bg-gray-200">
      ...
      <ul className="list-disc pl-6 mb-4">
        <li>
          Good for Frequent Access: LRU works well when pages accessed recently
          are likely to be accessed again soon.
        </li>
        <li>
          Easy to Understand: LRU is easy to understand and implement in theory.
          It's all about keeping track of which pages were used least recently.
        </li>
        <li>
